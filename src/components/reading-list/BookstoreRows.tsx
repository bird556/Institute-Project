...
import BookstoreRow, { type BookstoreRowProps } from '@/components/reading-list/BookstoreRow'

export default function BookstoreRows({ items }: { items: BookstoreRowProps[] }) {
