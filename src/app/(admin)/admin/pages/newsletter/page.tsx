...
export default async function NewsletterPageHeroEditor() {
  const { data: sections } = await getPageContent('newsletter')
    ...
    <div className="max-w-2xl mx-auto space-y-6 p-6">
      <div>
        ...
        <p className="text-sm text-[var(--color-text-muted)] mt-1">
          Edit the heading and subtitle shown at the top of the public Newsletter page.
        </p>
      </div>
      <PageHeroEditor
        page="newsletter"
